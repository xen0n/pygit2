...
class Option(IntEnum):
    ...
    GET_MWINDOW_FILE_LIMIT: int
    SET_MWINDOW_FILE_LIMIT: int
    GET_SEARCH_PATH: int
    SET_SEARCH_PATH: int
    ...
    GET_HOMEDIR: int
    SET_HOMEDIR: int
    GET_SERVER_CONNECT_TIMEOUT: int
    SET_SERVER_CONNECT_TIMEOUT: int
    ENABLE_HTTP_EXPECT_CONTINUE: int
    GET_EXTENSIONS: int
    SET_EXTENSIONS: int
    ADD_SSL_X509_CERT: int
    GET_USER_AGENT_PRODUCT: int
    SET_USER_AGENT_PRODUCT: int
    GET_SERVER_TIMEOUT: int
    SET_SERVER_TIMEOUT: int
    SET_ODB_PACKED_PRIORITY: int
    SET_ODB_LOOSE_PRIORITY: int

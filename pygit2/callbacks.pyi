...
class RemoteCallbacks(Payload):
    ...
    def __init__(
        ...
        certificate: _Certificate | None = None,
    ) -> None: ...
    ...
    def certificate_check(
        self, certificate: _Certificate, valid: bool, host: str
    ) -> bool: ...
...
_CredentialsFn: TypeAlias = Callable[
    [str | None, str | None, CredentialType], _Credentials
]
